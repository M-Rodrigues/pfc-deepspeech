...
cp CVData/LOG\_$N_HIDDEN.json /media/sf_vm-test-2/LOG\_$EXPERIMENTO.json
cp CVData/graphs/output_graph_$EXPERIMENTO.pbmm /media/sf_vm-test-2/output_graph_$EXPERIMENTO.pbmm
cp CVData/test\_$EXPERIMENTO.txt /media/sf_vm-test-2/test\_$EXPERIMENTO.txt
